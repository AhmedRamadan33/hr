        ...
        <div class="card-body">
          <table class="table ">
            ...
            <tr>
                ...
                <td> <a class="btn btn-danger" href="/hr/employees/list.php?deleteId=<?= $data['id']?>">Delete</a></td>
           <td><a class="btn btn-warning"  href="/hr/employees/edit.php?editId=<?= $data['id']?>">Edit</a></td>
            </tr>
            <?php endforeach ;?>
          </table>
        </div>
